...
#ifndef __ENEMY_HUNTER_BOSS_H__
#define __ENEMY_HUNTER_BOSS_H__
...
//노멀 2마리보다 "더 빠르고" "더 작고" "더 체력이 많음"

class CBossHunter : public CDynamicObject
{
protected:
	explicit CBossHunter(_Device pDevice);
	explicit CBossHunter(const CBossHunter& other);
...
public:
	static CBossHunter* Create(_Device pDevice);
