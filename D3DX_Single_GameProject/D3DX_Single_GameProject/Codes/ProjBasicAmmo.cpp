...
HRESULT CProjBasicAmmo::Ready_GameObject_Clone(void* pArg)
{
...
CProjBasicAmmo* CProjBasicAmmo::Create(_Device pDevice)
{
	CProjBasicAmmo* pInstance = new CProjBasicAmmo(pDevice);
...
Engine::CGameObject* CProjBasicAmmo::Clone(void* pArg)
{
	CProjBasicAmmo* pClone = new CProjBasicAmmo(*this);
	if (pClone == nullptr)
	{
		PRINT_LOG(L"Error", L"Failed To Clone CProjBasicAmmo");
	}
