...
//랜더 타입 (최우선, 알파없음, (알파처리: 알파-최우선, 반투명, 투명), (ZFalse 알파없음), 와이어프레임, UI
enum class RENDERID { RENDER_PRIORITY, RENDER_NOALPHA, RENDER_PRIORITY_ALPHA, RENDER_HALFALPHA, RENDER_ALPHA, RENDER_WIREFRAME, RENDER_EFFECT, RENDER_NOZ_NOALPHA, RENDER_TERMINAL_NOALPHA, RENDER_UI, RENDER_UI_ALPHA, RENDER_FINAL_ALPHA, RENDER_END };
