...
enum class RENDERID { RENDER_PRIORITY, RENDER_NOALPHA, RENDER_PRIORITY_ALPHA, RENDER_HALFALPHA, RENDER_ALPHA, RENDER_WIREFRAME, RENDER_EFFECT, RENDER_NOZ_NOALPHA, RENDER_TERMINAL_NOALPHA, RENDER_UI, RENDER_UI_ALPHA, RENDER_END };
